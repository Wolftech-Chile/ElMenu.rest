        ...
        <section id="section-cats" class="panel-section">
            ...
            <ul id="cat-list" class="cat-list">
                ...
                <li class="cat-item" draggable="true" data-id="<?= $c['id'] ?>">
                    ...
                    <button class="del-cat" title="Eliminar">
  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="6" width="18" height="14" rx="2"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="1" y1="6" x2="23" y2="6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>
</button>
                </li>
                <?php endforeach; ?>
            </ul>
            ...
            <ul class="dish-list" id="dish-list-<?= $cid ?>" data-cat="<?= $cid ?>">
                ...
                <li class="dish-item" draggable="true" data-id="<?= $p['id'] ?>">
                    ...
                    <div class="dish-actions">
                        <button class="icon-btn btn-img" title="Cambiar imagen">
  <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="#7ac943" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="13" rx="2"/><circle cx="12" cy="13.5" r="3.5"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
</button>
                        <button class="icon-btn del-dish" title="Eliminar">
  <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="6" width="18" height="14" rx="2"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="1" y1="6" x2="23" y2="6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>
</button>
                    </div>
                </li>
                <?php endforeach; ?>
        ...
        <section id="section-users" class="panel-section">
            ...
            <script>
                function mostrarOcultarContrasena(idInput) {
                    ...
                    if (input.type === 'password') {
                        input.type = 'text';
                        icono.innerHTML = '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/><line x1="12" y1="7" x2="12" y2="12"/><line x1="12" y1="12" x2="12" y2="17"/>';
                    } else {
                        input.type = 'password';
                        icono.innerHTML = '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>';
                    }
                }
                ...
                function editarUsuario(id, usuario, email, rol) {
                    ...
                    document.getElementById('btn-guardar-usuario').innerHTML = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="12" rx="9" ry="6"/><circle cx="12" cy="12" r="2.5"/><line x1="3" y1="3" x2="21" y2="21"/></svg> Guardar cambios';
                ...
                function cancelarEdicion() {
                    ...
                    document.getElementById('btn-guardar-usuario').innerHTML = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="12" rx="9" ry="6"/><circle cx="12" cy="12" r="2.5"/><line x1="3" y1="3" x2="21" y2="21"/></svg> Registrar Usuario';
            ...
            <style>
                ...
                .grupo-formulario input[type="text"], .grupo-formulario input[type="email"], .grupo-formulario input[type="password"], .grupo-formulario select {
                    width: 100%;
                    padding: 10px;
                    margin-bottom: 20px;
                ...
                .grupo-formulario .password-wrapper {
                    position: relative;
                }
                
                .grupo-formulario .password-wrapper button[type="button"] {
                    position: absolute;
                    top: 10px;
                    right: 10px;
                    background: none;
                ...
                .grupo-formulario .password-wrapper button[type="button"] svg {
                    width: 20px;
                    height: 20px;
                }
